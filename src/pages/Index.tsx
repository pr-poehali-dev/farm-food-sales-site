    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-primary text-primary-foreground shadow-md">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">ЭКО Ферма ИЗ ДИВНЫХ СНОВ</h1>
          </div>
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 animate-fade-in">
          <h2 className="text-5xl md:text-6xl font-bold mb-4">Натуральные продукты от ЭКО фермы</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-lg mb-4 text-muted-foreground">
                ЭКО Ферма «ИЗ ДИВНЫХ СНОВ» работает уже более 15 лет. Мы начинали с небольшого семейного хозяйства
      ...
      <footer className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-bold">ЭКО Ферма ИЗ ДИВНЫХ СНОВ</h3>
              </div>
          ...
          <div className="border-t border-primary-foreground/20 pt-6 text-center text-primary-foreground/80">
            <p>© 2026 ЭКО Ферма ИЗ ДИВНЫХ СНОВ. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
